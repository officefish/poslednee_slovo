...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'card_card', 'type')

        # Adding field 'Card.card_type'
        db.add_column(u'card_card', 'card_type',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'CardEptitude.type'
        db.delete_column(u'card_cardeptitude', 'type')

        # Adding field 'CardEptitude.eptityde_type'
        db.add_column(u'card_cardeptitude', 'eptityde_type',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'card_card', 'type',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Card.card_type'
        db.delete_column(u'card_card', 'card_type')

        # Adding field 'CardEptitude.type'
        db.add_column(u'card_cardeptitude', 'type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'CardEptitude.eptityde_type'
        db.delete_column(u'card_cardeptitude', 'eptityde_type')
    ...
    models = {
        ...
        u'card.cardeptitude': {
            ...
            'eptityde_type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
