...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Card.defence'
        db.delete_column(u'card_card', 'defence')

        # Adding field 'Card.defense'
        db.add_column(u'card_card', 'defense',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Card.defence'
        db.add_column(u'card_card', 'defence',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Card.defense'
        db.delete_column(u'card_card', 'defense')
