...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Card.race'
        db.alter_column(u'card_card', 'race_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['card.Race'], null=True))

    def backwards(self, orm):

        # Changing field 'Card.race'
        db.alter_column(u'card_card', 'race_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['card.Race']))
