...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CardEptitude.unit'
        db.add_column(u'card_cardeptitude', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='unit', null=True, to=orm['card.Card']),
                      keep_default=False)

        # Adding field 'CardEptitude.race'
        db.add_column(u'card_cardeptitude', 'race',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['card.Race'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'CardEptitude.subrace'
        db.add_column(u'card_cardeptitude', 'subrace',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['card.SubRace'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CardEptitude.unit'
        db.delete_column(u'card_cardeptitude', 'unit_id')

        # Deleting field 'CardEptitude.race'
        db.delete_column(u'card_cardeptitude', 'race_id')

        # Deleting field 'CardEptitude.subrace'
        db.delete_column(u'card_cardeptitude', 'subrace_id')
