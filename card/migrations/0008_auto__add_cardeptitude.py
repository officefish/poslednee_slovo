...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CardEptitude'
        db.create_table(u'card_cardeptitude', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('card', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['card.Card'])),
        ...
        db.send_create_signal(u'card', ['CardEptitude'])


    def backwards(self, orm):
        # Deleting model 'CardEptitude'
        db.delete_table(u'card_cardeptitude')
