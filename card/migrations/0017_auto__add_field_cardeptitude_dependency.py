...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CardEptitude.dependency'
        db.add_column(u'card_cardeptitude', 'dependency',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['card.CardEptitude'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CardEptitude.dependency'
        db.delete_column(u'card_cardeptitude', 'dependency_id')
