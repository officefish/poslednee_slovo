...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'card_book', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'card_book', 'description')
    ...
    models = {
        ...
        u'card.book': {
            ...
            'heroes': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'heroes'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['hero.Hero']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
