...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collection.max_length'
        db.add_column(u'card_collection', 'max_length',
                      self.gf('django.db.models.fields.IntegerField')(default=35),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collection.max_length'
        db.delete_column(u'card_collection', 'max_length')
