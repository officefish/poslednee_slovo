...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubRace'
        db.create_table(u'card_subrace', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('race', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['card.Race'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=70)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'card', ['SubRace'])

        # Adding model 'Race'
        db.create_table(u'card_race', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=70)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'card', ['Race'])

        # Adding field 'CardEptitude.pover'
        db.add_column(u'card_cardeptitude', 'pover',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SubRace'
        db.delete_table(u'card_subrace')

        # Deleting model 'Race'
        db.delete_table(u'card_race')

        # Deleting field 'CardEptitude.pover'
        db.delete_column(u'card_cardeptitude', 'pover')
