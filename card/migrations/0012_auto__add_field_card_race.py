...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Card.race'
        db.add_column(u'card_card', 'race',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['card.Race']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Card.race'
        db.delete_column(u'card_card', 'race_id')
