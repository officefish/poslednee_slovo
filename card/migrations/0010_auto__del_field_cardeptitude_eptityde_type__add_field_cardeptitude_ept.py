...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CardEptitude.eptitude_type'
        db.add_column(u'card_cardeptitude', 'eptitude_type',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CardEptitude.eptitude_type'
        db.delete_column(u'card_cardeptitude', 'eptitude_type')
